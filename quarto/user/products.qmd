...
The Nostradamus Cube comes pre-loaded with several high-value geospatial datasets. To help you get started quickly, we provide a collection of **Demonstration Notebooks** located in `./shared/notebooks_demo/`.
